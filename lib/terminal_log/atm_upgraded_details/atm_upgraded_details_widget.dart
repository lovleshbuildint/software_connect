...
class _AtmUpgradedDetailsWidgetState extends State<AtmUpgradedDetailsWidget> {
  ...
  void initState() {
    ...
    _model.atmid1Controller ??= TextEditingController();
    _model.atmid1FocusNode ??= FocusNode();
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    8.0, 0.0, 8.0, 0.0),
                                child: TextFormField(
                                  controller: _model.atmid1Controller,
                                  focusNode: _model.atmid1FocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  validator: _model.atmid1ControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                    ...
                    onPressed: () async {
                      if (_model.radioButtonValue == 'Log Upload') {
                        if (_model.atmid2Controller.text == null ||
                          ...
                          _model.terminalLog = await CreateTerminalLogCall.call(
                            token: getJsonField(
                        ...
                        if (_model.atmid1Controller.text == null ||
                            _model.atmid1Controller.text == '') {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
