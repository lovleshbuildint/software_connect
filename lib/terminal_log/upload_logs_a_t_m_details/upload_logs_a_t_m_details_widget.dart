...
import 'upload_logs_a_t_m_details_model.dart';
export 'upload_logs_a_t_m_details_model.dart';
...
class _UploadLogsATMDetailsWidgetState
    extends State<UploadLogsATMDetailsWidget> {
  late UploadLogsATMDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadLogsATMDetailsModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final uploadLogsATMDetailsBankModelSoftwareListResponse =
            snapshot.data!;
                                ...
                                builder: (context) {
                                  return GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: AtmUpgradedDetailsWidget(
                                        version: widget.version!,
                                        bankName: widget.bankName!,
                                        location: widget.location!,
                                        machineModel: widget.modelName!,
                                        bankId: widget.bankId!,
                                        modelId: widget.modelId!,
                                      ),
                                    ),
