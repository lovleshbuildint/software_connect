...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.rootCheckResponse = await actions.checkRoot();
      if (_model.rootCheckResponse!) {
        await showDialog(
          context: context,
          builder: (alertDialogContext) {
            return AlertDialog(
              title: Text('Alert'),
              content: Text('Devices is Rooted'),
              actions: [
                TextButton(
        ...
        if (FFAppState().loginResponse != null) {
          context.goNamed(
            'dashboard',
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Container(
            ...
            child: Padding(
              padding: EdgeInsetsDirectional.fromSTEB(14.0, 0.0, 14.0, 18.0),
              child: Column(
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if ((_model.emailAddressController.text != null &&
