  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final dashboardDasboardResponse = snapshot.data!;
                              ...
                              child: Builder(
                                builder: (context) {
                                  ...
                                  return SingleChildScrollView(
                                    ...
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children: List.generate(newUpdates.length,
                                          (newUpdatesIndex) {
                                        final newUpdatesItem =
                                            newUpdates[newUpdatesIndex];
                                        return Padding(
                                          padding:
                                                  ...
                                                  ClipRRect(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            8.0),
                                                    child: Image.asset(
                                                      'assets/images/Group_48097469.png',
                                                      width: 35.0,
                                                      height: 35.0,
                                                      fit: BoxFit.cover,
                                                    ),
                                                  ...
                                                  ClipRRect(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            8.0),
                                                    child: Image.asset(
                                                      'assets/images/Group_48097469_(1).png',
                                                      width: 35.0,
                                                      height: 35.0,
                                                      fit: BoxFit.cover,
                                                    ),
                            ...
                            child: Builder(
                              builder: (context) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, recentDownloadsIndex) {
                                    final recentDownloadsItem =
                                        recentDownloads[recentDownloadsIndex];
                                    return Container(
