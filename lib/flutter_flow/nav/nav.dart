...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'dowloadSoftware',
          path: '/dowloadSoftware',
          builder: (context, params) => DowloadSoftwareWidget(),
        ),
        FFRoute(
          name: 'atmModel',
          path: '/atmModel',
          builder: (context, params) => AtmModelWidget(
            bankId: params.getParam('bankId', ParamType.String),
            ...
            imageBin: params.getParam('imageBin', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'softwareDetails',
          path: '/softwareDetails',
          builder: (context, params) => SoftwareDetailsWidget(
            imageBin: params.getParam('imageBin', ParamType.String),
            softwareVersion:
                params.getParam('softwareVersion', ParamType.String),
            modelName: params.getParam('modelName', ParamType.String),
            uodatedOn: params.getParam('uodatedOn', ParamType.String),
        ...
        FFRoute(
          name: 'terminalLog',
          path: '/terminalLog',
          builder: (context, params) => TerminalLogWidget(),
        ),
        FFRoute(
          name: 'atmDetails',
          path: '/atmDetails',
        ...
        FFRoute(
          name: 'uploadLogsATMDetails',
          path: '/uploadLogsATMDetails',
          builder: (context, params) => UploadLogsATMDetailsWidget(
        ...
        FFRoute(
          name: 'softwareList',
          path: '/softwareList',
          builder: (context, params) => SoftwareListWidget(
            bankName: params.getParam('bankName', ParamType.String),
            modelName: params.getParam('modelName', ParamType.String),
            version: params.getParam('version', ParamType.String),
            imageBin: params.getParam('imageBin', ParamType.String),
